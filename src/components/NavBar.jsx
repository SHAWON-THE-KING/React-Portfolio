        ...
        <div className='container flex items-center justify-between'>
          <a href="#hero" className='text-xl font-bold text-primary flex items-center'>
            <span className=' relative z-10'>
              <span className=' text-glow text-foreground'>SHAWON ISLAM </span>
          ...
          <div className={cn("fixed inset-0 bg-background/50 backdrop-blur-md z-40 flex items-center justify-center",
